...
public class Casting {
   ...
   //    byte b = x ;
    ...
    //
    byte b = (byte) x; // need to be casted explicitly	//        byte b = (byte) x; // need to be casted explicitly
    ...
    // compile fine because Dog IS-A Object , BUT CLASS CAST EXCEPTION AT RUNTIME	//        // compile fine because Dog IS-A Object , BUT CLASS CAST EXCEPTION AT RUNTIME
    // Because d2 = new Object() will NOT WORK!!!	//        // Because d2 = new Object() will NOT WORK!!!
    Dog d2 = (Dog) o2;	//        Dog d2 = (Dog) o2;  //new Object();
        d2.bark();	//        d2.bark();
