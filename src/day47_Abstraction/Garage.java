...
public class Garage {
    ...
    public static void main(String[] args) {
     //   Car c1=new Car(); u can not be instantiated it means we cannot to create object

        // Abstract class can not be instantiated
        // It means we can not create object out of it	        // It means we can not create object out of it
//        Car c1 = new Car();	//        Car c = new Car();
