...
public class TaskArayRestaurants {
...
// System.out.println("Total number of restaurants: " + ???);
        ...
        System.out.println("Total number of restaurants: " + size);
...
//TASK 4. Count number of Popeye's Chicken, Domino's Pizza, Taco Bell
        ...
        System.out.println(" Popeye's Chicken " + popeyesCount);
        int dominosCount = 0;
        for (int i = 0; i < restaurants.length; i++) {
            if (restaurants[i].contains("Domino's Pizza")) {
                dominosCount++;
            }
        }
        System.out.println("Domino's Pizza " + dominosCount);
        int tacoBellCount = 0;
        for (int i = 0; i < restaurants.length; i++) {
            if (restaurants[i].contains("Taco Bell")) {
                tacoBellCount++;
            }
        }
        System.out.println("Taco Bell " + tacoBellCount);// //TASK 5. Find all McDonald's in TX and print out info with number:
        for(int i=0; i<restaurants.length;i++){
            if(restaurants[i].contains("McDonald's")&&restaurants[i].contains("TX")){
                System.out.println(restaurants[i]);}} //324 Main St,Massena,McDonald's,13662,NY,http://mcdonalds.comhttp://www.mcdonalds.com/?cid=RF:YXT_FM:TP::Yext:Referral
        ...
        String[] firstRes =restaurants[0].split(",");
        System.out.println(firstRes[2]+" -> "+firstRes[1]+", "+firstRes[4]);

        //TASK 7. Print each restaurant name, City, state in above format for all restaurants

        for(int i =0; i<restaurants.length; i++) {
            String[] rests = restaurants[i].split(",");
            System.out.println(rests[2] + " -> " + rests[1] + ", " + rests[4]);
