...
public class Employee {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < employees.length; i++){
            ...
            System.out.println(employees[i].substring(employees[i].indexOf("[") + 1, employees[i].lastIndexOf("]")));
        }
        System.out.println("==============================================================================");
        System.out.println("Task Print all FirstName-lastName jobTitle\n" +
                "Philipa-Salthouse Electrical Engineer\n" +
                "Ulrika-Goolding Nuclear Power Engineer");
        for (int i = 0; i < employees.length; i++) {
            System.out.println(employees[i].substring(employees[i].indexOf("\"") + 1, employees[i].indexOf("[") - 1) + " " + employees[i].substring(employees[i].indexOf("[") + 1, employees[i].lastIndexOf("]")));
        }
        System.out.println("*****===============================================================");
        System.out.println(" TASK 3. Look for those 2 people in the array and assert below data");
        ...
        for (String eachEmployee : employees) {
            ...
            } else if (eachEmployee.contains("Skipper Abrahamsson")) {
        ...
        System.out.println("===============================================================");
        System.out.println("Initials -> Job Title for everyone");
    //TB -> Geological Engineer
        String initialJob="";

        for (int i = 0; i < employees.length; i++){
       initialJob+=employees[i].charAt(employees[i].indexOf("\"")+1)+""+employees[i].charAt(employees[i].indexOf(" ")+1)+" -> "+

               employees[i].substring(employees[i].indexOf("[") + 1, employees[i].lastIndexOf("]"))+"\n";
